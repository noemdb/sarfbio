...
const words = ["automatiza", "revoluciona", "sustenta", "transforma"];
...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-background">
      {/* Background gradient - earthy agriculture theme */}
      <div className="absolute inset-0 z-0 bg-gradient-to-br from-background via-background to-card">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        <div className="mb-12">
          ...
          >
            <span className="block whitespace-nowrap">Robot que</span>
      ...
      >
        <div className="max-w-[1400px] mx-auto flex items-start gap-10 lg:gap-20">
          {[
            { value: "87%", label: "Reducción de desperdicio" },
            { value: "5 hectáreas", label: "Cobertura diaria" },
            { value: "45%", label: "Ahorro de costos" },
          ].map((stat) => (
