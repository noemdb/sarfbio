        ...
        >
          ...
          <a href="#" className="flex items-center gap-3 group">
            <img 
              ...
              alt="SARFBIO" 
              className={`transition-all duration-500 ${isScrolled ? "h-8" : "h-10"} w-auto rounded-lg`}
            />
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-base text-foreground" : "text-lg text-white"}`}>SARFBIO</span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Button
              size="sm"
              className={`rounded-full transition-all duration-500 ${isScrolled ? "bg-accent hover:bg-accent/90 text-white px-4 h-8 text-xs" : "bg-accent hover:bg-accent/90 text-white px-6"}`}
            >
              Explorar
            </Button>
          </div>
      ...
      >
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            ...
            <Button 
              className="flex-1 bg-accent text-white rounded-full h-14 text-base"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              Explorar
            </Button>
