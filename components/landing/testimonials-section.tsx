...
const testimonials = [
  {
    quote: "SARFBIO revolucionó mi forma de trabajar. Ahora aplico biopreparados con precisión y sin esfuerzo físico. La tecnología abierta me permite adaptar el robot a mis necesidades.",
    author: "Roberto García",
    role: "Productor Agrícola",
    company: "Santa Fe, Argentina",
    metric: { value: "87%", label: "Reducción de desperdicio" },
  },
  {
    quote: "Una tecnología innovadora que abre caminos hacia la agricultura del futuro. El equipo de SARFBIO entiende realmente nuestras necesidades como institución.",
    author: "Dr. Carlos López",
    role: "Director de Investigación",
    company: "INTA - Instituto Agrario",
    metric: { value: "ODS", label: "Cumplimiento certificado" },
  },
  {
    quote: "El costo de operación es mucho menor al de aplicación manual. Además, el código abierto nos da tranquilidad de poder repararlo y mejorarlo nosotros mismos.",
    author: "María Fernández",
    role: "Productora Orgánica",
    company: "Misiones, Argentina",
    metric: { value: "45%", label: "Ahorro anual" },
  },
  {
    quote: "SARFBIO es más que un robot: es una comunidad de agricultores innovadores comprometidos con la sustentabilidad. Eso es lo que realmente diferencia al proyecto.",
    author: "Juan Martínez",
    role: "Activista Agroecológico",
    company: "Red de Agricultura Sostenible",
    metric: { value: "24/7", label: "Operación continua" },
  },
];
